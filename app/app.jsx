...
import CorbelScopes from './components/iam/scopes/Scopes.jsx'
...
import ScopesDataAccessObject from './service/ScopesDataAccessObject'
...
var corbel = {
  ...
  ScopesDataAccessObject: ScopesDataAccessObject,
...
var sidebarEntries = [
  ...
  new SidebarEntry('Scopes', '#/scopes', 'newspaper'), 
